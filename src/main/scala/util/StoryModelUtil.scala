...
object StoryModelUtil {
  ...
  private val pathway1to4: Pathway = Pathway("go to 4", finalStoryNode4, alwaysTrueCondition)
  private val pathway2to5: Pathway = Pathway("go to 5", finalStoryNode5, alwaysTrueCondition)
  private val pathway2to6: Pathway = Pathway("go to 6", finalStoryNode6, alwaysTrueCondition)
  private val pathway3to6: Pathway = Pathway("go to 6", finalStoryNode6, alwaysTrueCondition)
  ...
  private val pathway0to1: Pathway = Pathway("go to 1", middleNode1, alwaysTrueCondition)
  private val pathway0to2: Pathway = Pathway("go to 2", middleNode2, alwaysTrueCondition)
  private val pathway0to3: Pathway = Pathway("go to 3", middleNode3, alwaysTrueCondition)
